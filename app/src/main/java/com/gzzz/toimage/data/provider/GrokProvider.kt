...
import com.gzzz.toimage.data.remote.GrokApiService
...
class GrokProvider @Inject constructor(
    ...
    private suspend fun processOutput(response: com.gzzz.toimage.data.remote.dto.GrokTaskResponse): GenerationResult? {
